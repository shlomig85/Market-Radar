...
DEFAULT_FEEDS: tuple[FeedDescriptor, ...] = (
    ...
    FeedDescriptor(
        key="federalreserve-monetary",
        name="Federal Reserve Monetary Policy Releases",
        publisher="Board of Governors of the Federal Reserve System",
        url="https://www.federalreserve.gov/feeds/press_monetary.xml",
        source_type=SourceType.GOVERNMENT_DATA,
        source_class=SourceClass.GOVERNMENT,
        base_quality=96,
        homepage_url="https://www.federalreserve.gov/monetarypolicy.htm",
    ),
    FeedDescriptor(
        key="sec-litigation",
        ...
        source_class=SourceClass.REGULATORY,
        base_quality=94,
        homepage_url="https://www.sec.gov/litigation/litreleases",
    ),
    FeedDescriptor(
        key="bls-news",
